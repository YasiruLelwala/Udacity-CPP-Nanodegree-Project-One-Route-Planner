...
void RoutePlanner::AddNeighbors(RouteModel::Node *current_node) 
{
    ...
    for (auto each_neighbor_node : current_node->neighbors) 
    {
        each_neighbor_node->parent = current_node;
        each_neighbor_node->h_value = CalculateHValue(each_neighbor_node);
        each_neighbor_node->g_value = current_node->g_value + current_node->distance(*(each_neighbor_node));
        open_list.emplace_back(each_neighbor_node);
        each_neighbor_node->visited = true;
    }
}
...
std::vector<RouteModel::Node> RoutePlanner::ConstructFinalPath(RouteModel::Node *current_node) 
{
    ...
    path_found.emplace_back(*current_node); // this is the starting node after while loop has ended.
